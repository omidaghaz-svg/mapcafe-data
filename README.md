...
candidates-loc.osm.pbf
        ...
        ▼
cafes.json.gz        (~۸۴۰KB ≈ ۱۸٬۹۳۲ مکان، هر مکان با فهرست `domains`)
...
**آمار واقعی (اجرای کامل روی PBF ایران، ۱ مهر ۱۴۰۵):** کل خروجی ۱۸٬۹۳۲ مکان
(۱۷٬۱۰۲ گره + ۱٬۷۲۷ way + ۱۰۳ relation). شمار مکان‌های هر نقشه (مکان ترکیبی در
...
| فست‌فود | ۴٬۲۳۲ | ۴٬۰۰۷ | ۱۹۸ | ۲۷ | ۳٬۸۶۰ |
| آبمیوه و بستنی | ۱٬۲۶۵ | ۱٬۱۸۸ | ۶۹ | ۸ | ۱٬۱۶۰ |
| کباب | ۱٬۷۲۳ | ۱٬۵۵۱ | ۱۶۰ | ۱۲ | ۱٬۶۸۹ |
| طباخی | ۵۵۲ | ۵۲۱ | ۲۸ | ۳ | ۵۴۹ |

از این میان ۱۶٬۳۰۳ مکان تک‌دامنه و ۲٬۶۲۹ مکان ترکیبی‌اند. پرتکرارترین ترکیب‌ها:
...
**پنج نکتهٔ مهم آماری:** اول، دامنهٔ کافه **دقیقاً** همان ۴٬۹۸۶ مکان پیشین است
...
با قاعدهٔ نام‌محور ۳۷۰ مکان رشد کرد** و نقشهٔ رستوران همان ۲۷۹ مکان را از دست
داد؛ چون OSM در ایران بسیاری از ساندویچی/پیتزایی/برگری را `amenity=restaurant`
ثبت می‌کند و رستوران نیستند (پایین را ببین).
...
فست‌فود **۳۷۰ مکان** رشد کرد (تفاوت، مکان‌هایی است که کافه هم بودند یا تازه
شناسایی شدند)؛ دامنهٔ کافه/آبمیوه/کباب/طباخی **دقیقاً بدون تغییر** ماند.
